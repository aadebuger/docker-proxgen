...
git checkout master
pwd
sed -i 's/https:\/\/googlemock.googlecode.com\/files/http:\/\/7xqqx7.com1.z0.glb.clouddn.com/g' CMakeLists.txt
# Build wangle
cmake .
make -j$JOBS
sudo make install
...
autoreconf -ivf
./configure
sed -i 's/https:\/\/googlemock.googlecode.com\/files/http:\/\/7xqqx7.com1.z0.glb.clouddn.com/g' lib/test/Makefile.in 
make -j$JOBS
